# Determine if the door to a minivan can be opened given the status
# of various switches and gear shift setting.
# Read the switch positions, and gear shift setting from the user.
db_left = bool(int(input("Left dashboard switch (0 or 2): ")))
